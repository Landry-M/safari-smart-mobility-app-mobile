...
class NetworkRegulatorHomeScreen extends StatefulWidget {
  const NetworkRegulatorHomeScreen({super.key});

  @override
  State<NetworkRegulatorHomeScreen> createState() =>
      _NetworkRegulatorHomeScreenState();
}

class _NetworkRegulatorHomeScreenState
    extends State<NetworkRegulatorHomeScreen> {
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoRow(
            ...
            label: 'Bus principal',
            value: bus?.numero ?? membre.busAffecte ?? 'Non défini',
          ),
        ],
      ),
    );
  ...
  void _placeholderFeature() {
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text(
          'Fonctionnalité régulateur de réseau en cours de développement.',
        ),
        ...
        return Scaffold(
          ...
          body: Padding(
            ...
            child: membre == null
                ? Center(
                    child: Text(
                      'Aucun régulateur de réseau n\'est actuellement en session.',
                ...
                : Column(
                    ...
                    children: [
                      ...
                      _buildActionCard(
                        icon: Icons.route,
                        title: 'Suivi du réseau',
                        subtitle:
                            'Surveiller les lignes, bus et trafic en temps réel. (à venir)',
                      ...
                      _buildActionCard(
                        ...
                        subtitle:
                            'Consulter les rapports de fréquentation et performances. (à venir)',
                        onTap: _placeholderFeature,
